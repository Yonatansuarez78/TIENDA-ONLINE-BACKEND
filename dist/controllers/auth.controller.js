...
exports.verifyToken = exports.updateUser = exports.register = exports.profile = exports.logout = exports.login = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          return _context.abrupt("return", res.status(400).json(["Correo electronico ya existe"]));
        case 7:
          _context.next = 9;
        ...
        case 13:
          ...
          _context.next = 16;
          return (0, _jwt.createAcessToken)({
            id: userSaved._id
          });
        case 16:
          token = _context.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 19:
          ...
          console.error(_context2.t0); // Imprime el error en la consola para debug
          res.status(500).json({
...
var verifyToken = exports.verifyToken = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return _context5.abrupt("return", res.send(false));
        case 3:
          _jsonwebtoken["default"].verify(token, _config.TOKEN_SECRET, /*#__PURE__*/function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(error, user) {
              var userFound;
  ...
  return function verifyToken(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var updateUser = exports.updateUser = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _req$body3, username, password, userId, updatedFields, salt, user, payload, newToken;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _req$body3 = req.body, username = _req$body3.username, password = _req$body3.password;
          userId = req.user.id; // Suponiendo que el ID del usuario viene del middleware de autenticación
          _context6.prev = 2;
          updatedFields = {}; // Validación básica (podrías usar una librería de validación más robusta)
        ...
        case 11:
          updatedFields.password = _context6.sent;
        case 12:
          _context6.next = 14;
          return _userModel["default"].findByIdAndUpdate(userId, updatedFields, {
            "new": true,
            select: '-password'
          });
        case 14:
        ...
        case 17:
          ...
          newToken = _jsonwebtoken["default"].sign(payload, _config.TOKEN_SECRET);
          res.json({
            user: user,
            token: newToken
          });
